...
- [x] Explain what a token is used for.
    ...
    a token is used to authentication.

- [x] What steps can you take in your web apps to keep your data secure?

    using tokens, private routes, and uthentication. 

- [x] Describe how web servers work.

    basically, clients request data from a server and the server responds accordingly. 
